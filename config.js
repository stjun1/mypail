...
module.exports = {
    ...
    KEYWORDS: {
        ...
        USER_POSITIVE: ['i am fine', "i'm fine", 'i am good', "i'm good", 'i am happy', "i'm happy", 'i am great', "i'm great", 'i am so happy', "i'm so happy", 'i am really happy', "i'm really happy", 'i am very happy', "i'm very happy", 'i am so good', "i'm so good", 'i am really good', "i'm really good", 'i am so great', "i'm so great", 'i am really great', "i'm really great", 'i am so excited', "i'm so excited", 'i am really excited', "i'm really excited", 'i love', 'excited', 'so happy', 'really happy', 'very happy', 'feeling good', 'feeling great', 'feeling happy'],
        USER_NEGATIVE: ['i am sad', "i'm sad", 'i am tired', "i'm tired", 'i am bad', 'not good', 'i am so sad', "i'm so sad", 'i am really sad', "i'm really sad", 'i am very sad', "i'm very sad", 'i am so tired', "i'm so tired", 'i am really tired', "i'm really tired", 'so sad', 'really sad', 'very sad', 'feeling sad', 'feeling bad', 'feeling down', 'angry', 'frustrated', 'annoyed', 'depressed', 'upset', 'miserable', 'heartbroken', 'devastated'],
