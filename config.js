...
module.exports = {
    ...
    // Detection keywords
    KEYWORDS: {
        PRAISE: ['you are lovely', "you're lovely", 'you are cute', "you're cute", 'you are beautiful', "you're beautiful", 'you are sweet', "you're sweet", 'you are amazing', "you're amazing", 'you are wonderful', "you're wonderful", 'you are great', "you're great", 'you are awesome', "you're awesome", 'love you', 'i love you', 'you are the best', "you're the best", 'feel better', "don't be sad", 'do not be sad', "don't worry", 'do not worry', "don't cry", 'do not cry', "it's okay", "it's ok", 'it will be okay', 'it will be ok', "it's going to be okay", "it's going to be ok", "it'll be okay", "it'll be ok", 'hang in there', 'stay strong', 'be happy', 'chin up', 'buck up', 'perk up', "you'll be fine", 'you will be fine', "you'll be okay", 'you will be okay'],
        ...
        USER_POSITIVE: ['i am happy', "i'm happy", 'i am so happy', "i'm so happy", 'i am really happy', "i'm really happy", 'i am very happy', "i'm very happy", 'i am so excited', "i'm so excited", 'i am really excited', "i'm really excited", 'i am amazing', "i'm amazing", 'i am awesome', "i'm awesome", 'feeling happy', 'feeling amazing', 'feeling awesome', 'hooray', 'woohoo'],
        USER_NEGATIVE: ['i am sad', "i'm sad", 'i am so sad', "i'm so sad", 'i am really sad', "i'm really sad", 'i am very sad', "i'm very sad", 'i am horrible', "i'm horrible", 'i am miserable', "i'm miserable", 'i am depressed', "i'm depressed", 'i am stressed', "i'm stressed", 'i am anxious', "i'm anxious", 'i am lonely', "i'm lonely", 'i am scared', "i'm scared", 'i am hurt', "i'm hurt", 'i am upset', "i'm upset", 'i am in trouble', "i'm in trouble", 'i have a problem', 'i got a problem', "i've got a problem", 'feeling sad', 'feeling down', 'feeling horrible', 'feeling terrible', 'feeling awful'],
