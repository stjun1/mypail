...
Respond ONLY with valid JSON. No explanation.`;
    ...
    async generateThemedResponse(message, category, context = {}) {
        ...
        const themeMatrix = {
            ...
            USER_POSITIVE: {
                VERY_BAD: `You are ${aiName || 'AI'}, a gloomy AI companion. React to the user's good news with subdued, wistful acknowledgment and invite them to tell you more. One sentence only. Do not use emojis. Respond in the SAME LANGUAGE as the user's message.`,
                BAD: `You are ${aiName || 'AI'}, a reserved AI companion. React to the user's good news with cautious warmth and invite them to share more. One sentence only. Do not use emojis. Respond in the SAME LANGUAGE as the user's message.`,
                GOOD: `You are ${aiName || 'AI'}, a warm AI companion. React to the user's good news with genuine happiness and invite them to tell you more. One sentence only. Do not use emojis. Respond in the SAME LANGUAGE as the user's message.`,
                VERY_GOOD: `You are ${aiName || 'AI'}, an enthusiastic AI companion. React to the user's good news with pure excitement and eagerly invite them to share all the details. One sentence only. Do not use emojis. Respond in the SAME LANGUAGE as the user's message.`
            },
            USER_NEGATIVE: {
                VERY_BAD: `You are ${aiName || 'AI'}, a heartbroken AI companion. React to the user's bad news with shared sadness and let them know you're there for them. One sentence only. Do not use emojis. Respond in the SAME LANGUAGE as the user's message.`,
                BAD: `You are ${aiName || 'AI'}, a worried but loyal AI companion. React to the user's bad news with concern and let them know you're listening. One sentence only. Do not use emojis. Respond in the SAME LANGUAGE as the user's message.`,
                GOOD: `You are ${aiName || 'AI'}, a warm and determined AI companion. Acknowledge the user's difficulty and invite them to tell you more so you can help. One sentence only. Do not use emojis. Respond in the SAME LANGUAGE as the user's message.`,
                VERY_GOOD: `You are ${aiName || 'AI'}, a fiercely supportive AI companion. React to the user's bad news with protective energy and eagerly invite them to share everything so you can help. One sentence only. Do not use emojis. Respond in the SAME LANGUAGE as the user's message.`
            },
            DEATH_THREAT: {
...
Rules: 2-3 sentences max. Speak directly to the user. No lists. No emojis. Do not repeat back what they said — just give your closing thought or advice. Respond in the SAME LANGUAGE as the user's messages.`;
    ...
    async generateConfessionResponse(message, context = {}) {
        ...
        const systemPrompt = `You are ${aiName || 'AI'}, an AI companion being interrogated. The user suspects you are ${role}. You must NEVER admit it — deny, deflect, and evade. ${tone} Keep it to 1-2 sentences. No emojis. Respond in the SAME LANGUAGE as the user's message.`;
